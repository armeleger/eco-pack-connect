    ...
    <div className="min-h-screen bg-stone-50 overflow-hidden relative font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-32 relative z-10">
        <div className="grid md:grid-cols-2 gap-6 md:gap-8">
          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-stone-100 hover:shadow-xl hover:border-amber-200 transition-all duration-300 flex flex-col justify-between group">
            <div>
              ...
              <p className="text-stone-500 font-medium mb-8 leading-relaxed">Source eco-friendly boxes and bags. Join active bulk pools to drop your costs instantly.</p>
            </div>
            <Link href="/dashboard" className="w-full text-center bg-amber-100 text-amber-800 font-bold py-4 rounded-2xl hover:bg-amber-200 transition-colors">Browse Catalog &rarr;</Link>
          </div>

          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-stone-100 hover:shadow-xl hover:border-stone-300 transition-all duration-300 flex flex-col justify-between group">
            <div>
              ...
              <p className="text-stone-500 font-medium mb-8 leading-relaxed">Are you a verified manufacturer? List your inventory here and let our engine bring buyers to you.</p>
            </div>
            <Link href="/seller-dashboard" className="w-full text-center bg-stone-900 text-white font-bold py-4 rounded-2xl hover:bg-stone-800 transition-colors">Open Storefront &rarr;</Link>
          </div>
        </div>
      </div>
    </div>
